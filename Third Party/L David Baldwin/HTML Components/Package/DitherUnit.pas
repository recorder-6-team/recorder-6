...
resourcestring
  ...
  ResStr_ValidColourBits =  'ColorBits must be 8 or less';
  ResStr_DitheredPixels = 'Dithered %d pixels in %d mS, Rate %d pixels/mS (%d pixels/S)';
...
var
  i			: integer;
begin
  ASSERT(ColorBits <= 8, ResStr_ValidColourBits);
...
{$ifdef DEBUG_DITHERPERFORMANCE}
  ...
  ShowMessage(format(ResStr_DitheredPixels,
