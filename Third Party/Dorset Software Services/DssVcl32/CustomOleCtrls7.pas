...
type
  ...
  TCustomOleControl = class;

  TEventDispatch = class(TObject, IUnknown, IDispatch)
  private
    FControl: TCustomOleControl;
  protected
    { IUnknown }
    ...
    property Control: TCustomOleControl read FControl;
  public
    constructor Create(Control: TCustomOleControl);
  end;
  ...
  TCustomOleControl = class(TWinControl, IUnknown, IOleClientSite,
  ...
  private
    ...
    FObjectData: HGlobal;
//    FOleObject: IOleObject;    // DSS - Moved to Protected section
  ...
  protected
    { DSS Change - FOLEObject now protected }
...
constructor TEventDispatch.Create(Control: TCustomOleControl);
begin
  FControl := Control;
end;
...
constructor TCustomOleControl.Create(AOwner: TComponent);
var
  I: Integer;
begin
...
destructor TCustomOleControl.Destroy;
...
procedure TCustomOleControl.BrowseProperties;
begin
  DoObjectVerb(OLEIVERB_PROPERTIES);
end;

procedure TCustomOleControl.CreateControl;
var
  Stream: IStream;
  CS: IOleClientSite;
  X: Integer;
...
procedure TCustomOleControl.CreateEnumPropDescs;
...
procedure TCustomOleControl.CreateInstance;
var
...
begin
  { Change - Don't do anything if we already have an OLE object }
...
procedure TCustomOleControl.CreateStorage;
var
  Stream: IStream;
begin
  DestroyStorage;
...
procedure TCustomOleControl.CreateWnd;
begin
  CreateControl;
  if FMiscStatus and OLEMISC_INVISIBLEATRUNTIME = 0 then
  begin
...
procedure TCustomOleControl.DefaultHandler(var Message);
begin
  try
...
function TCustomOleControl.SuppressException(E : Exception): boolean;
...
procedure TCustomOleControl.DefineProperties(Filer: TFiler);
begin
  try
...
procedure TCustomOleControl.DesignModified;
var
  Form: TCustomForm;
begin
...
procedure TCustomOleControl.DestroyControl;
begin
...
procedure TCustomOleControl.DestroyEnumPropDescs;
var
  I: Integer;
begin
...
procedure TCustomOleControl.DestroyStorage;
begin
...
procedure TCustomOleControl.DestroyWindowHandle;
begin
  if FMiscStatus and OLEMISC_INVISIBLEATRUNTIME = 0 then
  begin
...
procedure TCustomOleControl.DoObjectVerb(Verb: Integer);
var
  ActiveWindow: HWnd;
  WindowList: Pointer;
begin
...
function TCustomOleControl.GetByteProp(Index: Integer): Byte;
begin
  Result := GetIntegerProp(Index);
end;

function TCustomOleControl.GetColorProp(Index: Integer): TColor;
begin
  Result := GetIntegerProp(Index);
end;

function TCustomOleControl.GetTColorProp(Index: Integer): TColor;
begin
  Result := GetIntegerProp(Index);
end;

function TCustomOleControl.GetCompProp(Index: Integer): Comp;
begin
  Result := GetDoubleProp(Index);
end;

function TCustomOleControl.GetCurrencyProp(Index: Integer): Currency;
var
  Temp: TVarData;
begin
...
function TCustomOleControl.GetDoubleProp(Index: Integer): Double;
var
  Temp: TVarData;
begin
  GetProperty(Index, Temp);
...
function TCustomOleControl.GetEnumPropDesc(DispID: Integer): TEnumPropDesc;
var
  I: Integer;
begin
  with FControlData^ do
...
procedure TCustomOleControl.GetEventMethod(DispID: TDispID; var Method: TMethod);
asm
        PUSH    EBX
        PUSH    ESI
        PUSH    EDI
        PUSH    ECX
        MOV     EBX,EAX
        MOV     ECX,[EBX].TCustomOleControl.FControlData
...
{ TCustomOleControl.GetHelpContext:  Fetch the help file name and help context
...
function TCustomOleControl.GetHelpContext(Member: string;
...
function TCustomOleControl.GetIDispatchProp(Index: Integer): IDispatch;
var
  Temp: TVarData;
begin
  GetProperty(Index, Temp);
...
function TCustomOleControl.GetIntegerProp(Index: Integer): Integer;
var
  Temp: TVarData;
begin
  GetProperty(Index, Temp);
...
function TCustomOleControl.GetIUnknownProp(Index: Integer): IUnknown;
var
  Temp: TVarData;
begin
  GetProperty(Index, Temp);
...
function TCustomOleControl.GetMainMenu: TMainMenu;
var
  Form: TCustomForm;
begin
  Result := nil;
...
procedure TCustomOleControl.GetObjectVerbs(List: TStrings);
var
...
function TCustomOleControl.GetWordBoolProp(Index: Integer): WordBool;
var
  Temp: TVarData;
begin
  GetProperty(Index, Temp);
...
function TCustomOleControl.GetTDateTimeProp(Index: Integer): TDateTime;
var
  Temp: TVarData;
begin
  GetProperty(Index, Temp);
...
function TCustomOleControl.GetTFontProp(Index: Integer): TFont;
var
  I: Integer;
begin
  Result := nil;
...
function TCustomOleControl.GetOleBoolProp(Index: Integer): TOleBool;
var
  Temp: TVarData;
begin
  GetProperty(Index, Temp);
...
function TCustomOleControl.GetOleDateProp(Index: Integer): TOleDate;
var
  Temp: TVarData;
begin
  GetProperty(Index, Temp);
...
function TCustomOleControl.GetOleEnumProp(Index: Integer): TOleEnum;
begin
  Result := GetIntegerProp(Index);
end;

function TCustomOleControl.GetTOleEnumProp(Index: Integer): TOleEnum;
begin
  Result := GetIntegerProp(Index);
end;

function TCustomOleControl.GetOleObject: Variant;
begin
  CreateControl;
  Result := Variant(FOleObject as IDispatch);
end;

function TCustomOleControl.GetDefaultDispatch: IDispatch;
begin
  CreateControl;
  Result := FOleObject as IDispatch;
end;

function TCustomOleControl.GetOleVariantProp(Index: Integer): OleVariant;
begin
  VarClear(Result);
  GetProperty(Index, TVarData(Result));
end;

function TCustomOleControl.GetTPictureProp(Index: Integer): TPicture;
var
  I: Integer;
begin
  Result := nil;
...
function TCustomOleControl.GetPropDisplayString(DispID: Integer): string;
var
  S: WideString;
begin
  CreateControl;
...
procedure TCustomOleControl.GetPropDisplayStrings(DispID: Integer; List: TStrings);
var
  Strings: TCAPOleStr;
  Cookies: TCALongint;
  I: Integer;
...
procedure TCustomOleControl.GetProperty(Index: Integer; var Value: TVarData);
var
  Status: HResult;
...
function TCustomOleControl.GetShortIntProp(Index: Integer): ShortInt;
begin
  Result := GetIntegerProp(Index);
end;

function TCustomOleControl.GetSingleProp(Index: Integer): Single;
var
  Temp: TVarData;
begin
  GetProperty(Index, Temp);
...
function TCustomOleControl.GetSmallintProp(Index: Integer): Smallint;
var
  Temp: TVarData;
begin
  GetProperty(Index, Temp);
...
function TCustomOleControl.GetStringProp(Index: Integer): string;
begin
  Result := GetVariantProp(Index);
end;

function TCustomOleControl.GetVariantProp(Index: Integer): Variant;
begin
  Result := GetOleVariantProp(Index);
end;

function TCustomOleControl.GetWideStringProp(Index: Integer): WideString;
var
  Temp: TVarData;
begin
  Result := '';
...
function TCustomOleControl.GetWordProp(Index: Integer): Word;
begin
  Result := GetIntegerProp(Index);
end;

procedure TCustomOleControl.HookControlWndProc;
var
  WndHandle: HWnd;
begin
...
procedure TCustomOleControl.D2InvokeEvent(DispID: TDispID; var Params: TDispParams);
type
  TStringDesc = record
    PStr: Pointer;
    BStr: PBStr;
...
procedure TCustomOleControl.InvokeEvent(DispID: TDispID; var Params: TDispParams);
var
  EventMethod: TMethod;
begin
...
procedure TCustomOleControl.InitControlInterface;
begin
end;

procedure TCustomOleControl.InvokeMethod(const DispInfo; Result: Pointer); assembler;
asm
        PUSH    EBX
        PUSH    ESI
        PUSH    EDI
        ...
        MOV     ESI,EDX
        MOV     EDI,ECX
        CALL    TCustomOleControl.CreateControl
...
@@1:    PUSH    EAX
        ...
        MOV     EAX,[EBX].TCustomOleControl.FControlDispatch
        CALL    DispatchInvoke
        XOR     EAX,EAX
...
function TCustomOleControl.IsCustomProperty(DispID: Integer): Boolean;
var
  W: WideString;
begin
...
function TCustomOleControl.IsPropPageProperty(DispID: Integer): Boolean;
var
  PPID: TCLSID;
begin
  Result := (FPropBrowsing <> nil) and
...
function TCustomOleControl.PaletteChanged(Foreground: Boolean): Boolean;
begin
  Result := False;
...
procedure TCustomOleControl.PictureChanged(Sender: TObject);
var
  I: Integer;
begin
...
procedure TCustomOleControl.ReadData(Stream: TStream);
var
  Buffer: Pointer;
begin
  DestroyStorage;
...
procedure TCustomOleControl.SetBounds(ALeft, ATop, AWidth, AHeight: Integer);
begin
...
procedure TCustomOleControl.SetByteProp(Index: Integer; Value: Byte);
begin
  SetIntegerProp(Index, Value);
end;

procedure TCustomOleControl.SetColorProp(Index: Integer; Value: TColor);
begin
  SetIntegerProp(Index, Value);
end;

procedure TCustomOleControl.SetTColorProp(Index: Integer; Value: TColor);
begin
  SetIntegerProp(Index, Value);
end;

procedure TCustomOleControl.SetCompProp(Index: Integer; const Value: Comp);
var
  Temp: TVarData;
begin
  Temp.VType := VT_I8;
...
procedure TCustomOleControl.SetCurrencyProp(Index: Integer; const Value: Currency);
var
  Temp: TVarData;
begin
...
procedure TCustomOleControl.SetDoubleProp(Index: Integer; const Value: Double);
var
  Temp: TVarData;
begin
...
procedure TCustomOleControl.SetIDispatchProp(Index: Integer; const Value: IDispatch);
var
  Temp: TVarData;
begin
...
procedure TCustomOleControl.SetIntegerProp(Index: Integer; Value: Integer);
var
  Temp: TVarData;
begin
...
procedure TCustomOleControl.SetIUnknownProp(Index: Integer; const Value: IUnknown);
var
  Temp: TVarData;
begin
...
procedure TCustomOleControl.SetName(const Value: TComponentName);
var
  OldName: string;
  DispID: Integer;
begin
...
procedure TCustomOleControl.SetWordBoolProp(Index: Integer; Value: WordBool);
var
  Temp: TVarData;
begin
...
procedure TCustomOleControl.SetTDateTimeProp(Index: Integer; const Value: TDateTime);
var
  Temp: TVarData;
begin
  Temp.VType := varDate;
...
procedure TCustomOleControl.SetTFontProp(Index: Integer; Value: TFont);
var
  I: Integer;
  F: TFont;
  Temp: IFontDisp;
...
procedure TCustomOleControl.SetOleBoolProp(Index: Integer; Value: TOleBool);
var
  Temp: TVarData;
begin
  Temp.VType := varBoolean;
...
procedure TCustomOleControl.SetOleDateProp(Index: Integer; const Value: TOleDate);
var
  Temp: TVarData;
begin
  Temp.VType := varDate;
...
procedure TCustomOleControl.SetOleEnumProp(Index: Integer; Value: TOleEnum);
begin
  SetIntegerProp(Index, Value);
end;

procedure TCustomOleControl.SetTOleEnumProp(Index: Integer; Value: TOleEnum);
begin
  SetIntegerProp(Index, Value);
end;

procedure TCustomOleControl.SetOleVariantProp(Index: Integer; const Value: OleVariant);
begin
  SetProperty(Index, TVarData(Value));
end;

procedure TCustomOleControl.SetParent(AParent: TWinControl);
var
  CS: IOleClientSite;
  X: Integer;
begin
...
procedure TCustomOleControl.SetTPictureProp(Index: Integer; Value: TPicture);
var
  I: Integer;
  P: TPicture;
  Temp: IPictureDisp;
...
procedure TCustomOleControl.SetPropDisplayString(DispID: Integer;
  const Value: string);
var
  I: Integer;
  Values: TStringList;
...
procedure TCustomOleControl.SetProperty(Index: Integer; const Value: TVarData);
const
...
procedure TCustomOleControl.SetShortintProp(Index: Integer; Value: ShortInt);
begin
  SetIntegerProp(Index, Value);
end;

procedure TCustomOleControl.SetSingleProp(Index: Integer; const Value: Single);
var
  Temp: TVarData;
begin
...
procedure TCustomOleControl.SetSmallintProp(Index: Integer; Value: Smallint);
var
  Temp: TVarData;
begin
...
procedure TCustomOleControl.SetStringProp(Index: Integer; const Value: string);
var
  Temp: TVarData;
begin
...
procedure TCustomOleControl.SetUIActive(Active: Boolean);
var
  Form: TCustomForm;
begin
  Form := GetParentForm(Self);
...
procedure TCustomOleControl.SetVariantProp(Index: Integer; const Value: Variant);
begin
  SetOleVariantProp(Index, Value);
end;

procedure TCustomOleControl.SetWideStringProp(Index: Integer; const Value: WideString);
var
  Temp: TVarData;
begin
  Temp.VType := varOleStr;
...
procedure TCustomOleControl.SetWordProp(Index: Integer; Value: Word);
begin
  SetIntegerProp(Index, Value);
end;

procedure TCustomOleControl._SetColorProp(Index: Integer; Value: TColor);
begin
  SetColorProp(Index, Value);
end;

procedure TCustomOleControl._SetTColorProp(Index: Integer; Value: TColor);
begin
  SetTColorProp(Index, Value);
end;

procedure TCustomOleControl._SetTOleEnumProp(Index: Integer; Value: TOleEnum);
begin
  SetTOleEnumProp(Index, Value);
end;

procedure TCustomOleControl._SetTFontProp(Index: Integer; Value: TFont);
begin
  SetTFontProp(Index, Value);
end;

procedure TCustomOleControl._SetTPictureProp(Index: Integer; Value: TPicture);
begin
  SetTPictureProp(Index, Value);
end;


procedure TCustomOleControl.ShowAboutBox;
const
...
procedure TCustomOleControl.StandardEvent(DispID: TDispID; var Params: TDispParams);
type
...
procedure TCustomOleControl.WndProc(var Message: TMessage);
var
  WinMsg: TMsg;
begin
...
procedure TCustomOleControl.WriteData(Stream: TStream);
var
...
procedure TCustomOleControl.WMEraseBkgnd(var Message: TWMEraseBkgnd);
begin
  if FMiscStatus and OLEMISC_INVISIBLEATRUNTIME = 0 then
...
procedure TCustomOleControl.WMPaint(var Message: TWMPaint);
var
  DC: HDC;
  PS: TPaintStruct;
begin
...
procedure TCustomOleControl.CMDocWindowActivate(var Message: TMessage);
var
  Form: TCustomForm;
  F: TForm;
begin
...
procedure TCustomOleControl.CMColorChanged(var Message: TMessage);
begin
  inherited;
...
procedure TCustomOleControl.CMEnabledChanged(var Message: TMessage);
begin
  inherited;
...
procedure TCustomOleControl.CMFontChanged(var Message: TMessage);
begin
  inherited;
...
procedure TCustomOleControl.CMDialogKey(var Message: TMessage);
var
  Info: TControlInfo;
  Msg: TMsg;
  Cmd: Word;
...
procedure TCustomOleControl.CMUIActivate(var Message: TMessage);
var
  F: TCustomForm;
begin
...
procedure TCustomOleControl.CMUIDeactivate(var Message: TMessage);
var
  F: TCustomForm;
begin
  F := GetParentForm(Self);
...
{ TCustomOleControl.IUnknown }

function TCustomOleControl.QueryInterface(const IID: TGUID; out Obj): HResult;
begin
  if GetInterface(IID, Obj) then Result := S_OK else Result := E_NOINTERFACE;
end;

function TCustomOleControl._AddRef: Integer;
begin
  Inc(FRefCount);
  Result := FRefCount;
end;

function TCustomOleControl._Release: Integer;
begin
  Dec(FRefCount);
  Result := FRefCount;
end;

{ TCustomOleControl.IOleClientSite }

function TCustomOleControl.SaveObject: HResult;
begin
  Result := S_OK;
end;

function TCustomOleControl.GetMoniker(dwAssign: Longint; dwWhichMoniker: Longint;
  out mk: IMoniker): HResult;
begin
  Result := E_NOTIMPL;
end;

function TCustomOleControl.GetContainer(out container: IOleContainer): HResult;
begin
  Result := E_NOINTERFACE;
end;

function TCustomOleControl.ShowObject: HResult;
begin
  HookControlWndProc;
  Result := S_OK;
end;

function TCustomOleControl.OnShowWindow(fShow: BOOL): HResult;
begin
  Result := S_OK;
end;

function TCustomOleControl.RequestNewObjectLayout: HResult;
var
  Extent: TPoint;
  W, H: Integer;
begin
...
{ TCustomOleControl.IOleControlSite }

function TCustomOleControl.OnControlInfoChanged: HResult;
begin
  Result := E_NOTIMPL;
end;

function TCustomOleControl.LockInPlaceActive(fLock: BOOL): HResult;
begin
  Result := E_NOTIMPL;
end;

function TCustomOleControl.GetExtendedControl(out disp: IDispatch): HResult;
begin
  Result := E_NOTIMPL;
end;

function TCustomOleControl.TransformCoords(var ptlHimetric: TPoint;
...
function TCustomOleControl.OleControlSite_TranslateAccelerator(
  msg: PMsg; grfModifiers: Longint): HResult;
begin
  Result := E_NOTIMPL;
end;

function TCustomOleControl.OnFocus(fGotFocus: BOOL): HResult;
begin
  Result := E_NOTIMPL;
end;

function TCustomOleControl.ShowPropertyFrame: HResult;
begin
  Result := E_NOTIMPL;
end;

{ TCustomOleControl.IOleWindow }

function TCustomOleControl.ContextSensitiveHelp(fEnterMode: BOOL): HResult;
begin
  Result := S_OK;
end;

{ TCustomOleControl.IOleInPlaceSite }

function TCustomOleControl.OleInPlaceSite_GetWindow(out wnd: HWnd): HResult;
begin
  Result := S_OK;
  wnd := GetParentHandle;
...
function TCustomOleControl.CanInPlaceActivate: HResult;
begin
  Result := S_OK;
end;

function TCustomOleControl.OnInPlaceActivate: HResult;
begin
...
function TCustomOleControl.OnUIActivate: HResult;
begin
  SetUIActive(True);
  Result := S_OK;
end;

function TCustomOleControl.GetWindowContext(out frame: IOleInPlaceFrame;
  out doc: IOleInPlaceUIWindow; out rcPosRect: TRect;
  out rcClipRect: TRect; out frameInfo: TOleInPlaceFrameInfo): HResult;
begin
  frame := Self;
...
function TCustomOleControl.Scroll(scrollExtent: TPoint): HResult;
begin
  Result := E_NOTIMPL;
end;

function TCustomOleControl.OnUIDeactivate(fUndoable: BOOL): HResult;
begin
  SetMenu(0, 0, 0);
  SetUIActive(False);
  Result := S_OK;
...
function TCustomOleControl.OnInPlaceDeactivate: HResult;
begin
...
function TCustomOleControl.DiscardUndoState: HResult;
begin
  Result := E_NOTIMPL;
end;

function TCustomOleControl.DeactivateAndUndo: HResult;
begin
  FOleInPlaceObject.UIDeactivate;
  Result := S_OK;
end;

function TCustomOleControl.OnPosRectChange(const rcPosRect: TRect): HResult;
begin
  FOleInPlaceObject.SetObjectRects(rcPosRect, Rect(0, 0, 32767, 32767));
  Result := S_OK;
end;

{ TCustomOleControl.IOleInPlaceUIWindow }

function TCustomOleControl.GetBorder(out rectBorder: TRect): HResult;
begin
  Result := INPLACE_E_NOTOOLSPACE;
end;

function TCustomOleControl.RequestBorderSpace(const borderwidths: TRect): HResult;
begin
  Result := INPLACE_E_NOTOOLSPACE;
end;

function TCustomOleControl.SetBorderSpace(pborderwidths: PRect): HResult;
begin
  Result := E_NOTIMPL;
end;

function TCustomOleControl.SetActiveObject(const activeObject: IOleInPlaceActiveObject;
  pszObjName: POleStr): HResult;
begin
  Result := S_OK;
end;

{ TCustomOleControl.IOleInPlaceFrame }

function TCustomOleControl.OleInPlaceFrame_GetWindow(out wnd: HWnd): HResult;
begin
  wnd := GetTopParentHandle;
  Result := S_OK;
end;

function TCustomOleControl.InsertMenus(hmenuShared: HMenu;
...
function TCustomOleControl.SetMenu(hmenuShared: HMenu; holemenu: HMenu;
...
function TCustomOleControl.RemoveMenus(hmenuShared: HMenu): HResult;
begin
...
function TCustomOleControl.SetStatusText(pszStatusText: POleStr): HResult;
begin
  Result := S_OK;
end;

function TCustomOleControl.EnableModeless(fEnable: BOOL): HResult;
begin
  Result := S_OK;
end;

function TCustomOleControl.OleInPlaceFrame_TranslateAccelerator(
  var msg: TMsg; wID: Word): HResult;
begin
  Result := S_FALSE;
end;

{ TCustomOleControl.IDispatch }

function TCustomOleControl.GetTypeInfoCount(out Count: Integer): HResult;
begin
  Count := 0;
  Result := S_OK;
end;

function TCustomOleControl.GetTypeInfo(Index, LocaleID: Integer;
  out TypeInfo): HResult;
begin
  Pointer(TypeInfo) := nil;
  Result := E_NOTIMPL;
...
function TCustomOleControl.GetIDsOfNames(const IID: TGUID; Names: Pointer;
  NameCount, LocaleID: Integer; DispIDs: Pointer): HResult;
begin
  Result := E_NOTIMPL;
end;

function TCustomOleControl.Invoke(DispID: Integer; const IID: TGUID;
  LocaleID: Integer; Flags: Word; var Params;
  VarResult, ExcepInfo, ArgErr: Pointer): HResult;
var
  F: TFont;
    ...
    case DispID of
      ...
      begin
        if (Parent <> nil) and ParentFont then
          F := TCustomOleControl(Parent).Font
        else
          F := Font;
...
{ TCustomOleControl.IPropertyNotifySink }

function TCustomOleControl.OnChanged(dispid: TDispID): HResult;
begin
  try
    case dispid of
      DISPID_BACKCOLOR:
...
function TCustomOleControl.OnRequestEdit(dispid: TDispID): HResult;
begin
  Result := S_OK;
end;

{ TCustomOleControl.ISimpleFrameSite }

function TCustomOleControl.PreMessageFilter(wnd: HWnd; msg, wp, lp: Integer;
  out res: Integer; out Cookie: Longint): HResult;
begin
  Result := S_OK;
end;

function TCustomOleControl.PostMessageFilter(wnd: HWnd; msg, wp, lp: Integer;
...
initialization
  GroupDescendentsWith(TCustomOleControl, Controls.TControl);
