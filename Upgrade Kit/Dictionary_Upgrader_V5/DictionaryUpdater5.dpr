...
uses
  ...
  LoginFrame in 'LoginFrame.pas' {fraLogin: TFrame},
  ...
  UpdaterFrame in 'UpdaterFrame.pas' {fraDicUpdater: TFrame},
  ...
  DicProgress in 'DicProgress.pas' {fraDicProgress: TFrame};
