...
// PASTLWTR : 1.2
// File generated on 24/09/2015 09:41:25 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\Localsource\Recorder\RecorderApp\trunk\Add-ins\Indicia2Recorder\Indicia2Recorder.tlb (1)
// LIBID: {50F9696E-9529-44B4-97D4-6EC8F4F8A9D2}
// LCID: 0
// Helpfile: 
// HelpString: Indicia2Recorder Library
// DepndLst: 
...
const
  ...
  Indicia2RecorderMajorVersion = 1;
  Indicia2RecorderMinorVersion = 0;

  LIBID_Indicia2Recorder: TGUID = '{50F9696E-9529-44B4-97D4-6EC8F4F8A9D2}';

  IID_IDownloadDialog: TGUID = '{9140EA45-1909-4A0D-9D9D-E8F0DA2E0F9D}';
  DIID_IDownloadDialogEvents: TGUID = '{AAC2E6CA-75E1-47C2-969C-B016891AD271}';
  CLASS_DownloadDialog: TGUID = '{69E97028-BE51-4E94-86FD-3C02F783EC67}';
...
// *********************************************************************//
  IDownloadDialog = interface;
  IDownloadDialogDisp = dispinterface;
  IDownloadDialogEvents = dispinterface;

// *********************************************************************//
// Declaration of CoClasses defined in Type Library                       
// (NOTE: Here we map each CoClass to its Default Interface)              
// *********************************************************************//
  DownloadDialog = IDownloadDialog;
...
// GUID:      {9140EA45-1909-4A0D-9D9D-E8F0DA2E0F9D}
// *********************************************************************//
  IDownloadDialog = interface(IDispatch)
    ['{9140EA45-1909-4A0D-9D9D-E8F0DA2E0F9D}']
...
// *********************************************************************//
// DispIntf:  IDownloadDialogEvents
// Flags:     (4096) Dispatchable
// GUID:      {AAC2E6CA-75E1-47C2-969C-B016891AD271}
// *********************************************************************//
  IDownloadDialogEvents = dispinterface
    ['{AAC2E6CA-75E1-47C2-969C-B016891AD271}']
...
// Control Name     : TDownloadDialog
// Help String      : DownloadDialog Control
// Default Interface: IDownloadDialog
// Def. Intf. DISP? : No
// Event   Interface: IDownloadDialogEvents
// TypeFlags        : (34) CanCreate Control
// *********************************************************************//
  TDownloadDialogOnKeyPress = procedure(ASender: TObject; var Key: Smallint) of object;

  TDownloadDialog = class(TOleControl)
  private
    ...
    FOnKeyPress: TDownloadDialogOnKeyPress;
    FOnPaint: TNotifyEvent;
    FIntf: IDownloadDialog;
    function  GetControlInterface: IDownloadDialog;
  protected
    procedure CreateControl;
    procedure InitControlData; override;
  public
    property  ControlInterface: IDownloadDialog read GetControlInterface;
    property  DefaultInterface: IDownloadDialog read GetControlInterface;
  ...
  published
    ...
    property OnKeyPress: TDownloadDialogOnKeyPress read FOnKeyPress write FOnKeyPress;
...
procedure TDownloadDialog.InitControlData;
const
  ...
  CControlData: TControlData2 = (
    ClassID: '{69E97028-BE51-4E94-86FD-3C02F783EC67}';
...
procedure TDownloadDialog.CreateControl;

  procedure DoCreate;
  begin
    FIntf := IUnknown(OleObject) as IDownloadDialog;
  end;
...
function TDownloadDialog.GetControlInterface: IDownloadDialog;
begin
  CreateControl;
  Result := FIntf;
end;
...
procedure Register;
begin
  RegisterComponents(dtlOcxPage, [TDownloadDialog]);
end;
