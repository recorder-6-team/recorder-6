...
procedure GetDllList (const AFileName: String; AList: TStringList);
...
var fs: TFileStream;
        ...
        begin
          if CurSection^.VirtualAddress = ImportAddr then begin
            ...
            repeat
              ...
              AList.Add (ReadSZString (CurSection^.PointerToRawData +
  ...
  //----------------------------------------------------------------------------
begin
  if not FileExists (AFileName) then raise Exception.Create (ResStr_FileNotFound);
