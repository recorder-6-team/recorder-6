...
// LCID: 0
// Helpfile: 
// HelpString: AtlasExporter Library
// DepndLst: 
...
const
  ...
  AtlasExporterMajorVersion = 1;
  AtlasExporterMinorVersion = 0;

  LIBID_AtlasExporter: TGUID = '{DE71CFB8-BB8B-48CE-BA52-D4A14D081548}';

  IID_IReportButton: TGUID = '{081AA231-9FB9-46FD-8DA9-BD8B243B6AD6}';
  DIID_IReportButtonEvents: TGUID = '{544C4D6E-835F-4F74-8079-8BB359179EAF}';
  CLASS_ReportButton: TGUID = '{149CEA2D-A00C-4509-BBDD-1155C4CD2204}';
...
// *********************************************************************//
  IReportButton = interface;
  IReportButtonDisp = dispinterface;
  IReportButtonEvents = dispinterface;
...
// GUID:      {081AA231-9FB9-46FD-8DA9-BD8B243B6AD6}
// *********************************************************************//
  IReportButton = interface(IDispatch)
    ['{081AA231-9FB9-46FD-8DA9-BD8B243B6AD6}']
...
// *********************************************************************//
// DispIntf:  IReportButtonEvents
// Flags:     (4096) Dispatchable
// GUID:      {544C4D6E-835F-4F74-8079-8BB359179EAF}
// *********************************************************************//
  IReportButtonEvents = dispinterface
    ['{544C4D6E-835F-4F74-8079-8BB359179EAF}']
...
// Control Name     : TReportButton
// Help String      : ReportButton Control
// Default Interface: IReportButton
// Def. Intf. DISP? : No
// Event   Interface: IReportButtonEvents
// TypeFlags        : (34) CanCreate Control
// *********************************************************************//
  TReportButtonOnKeyPress = procedure(ASender: TObject; var Key: Smallint) of object;

  TReportButton = class(TOleControl)
  private
    ...
    FOnKeyPress: TReportButtonOnKeyPress;
    FOnPaint: TNotifyEvent;
    FIntf: IReportButton;
    function  GetControlInterface: IReportButton;
  protected
    procedure CreateControl;
    procedure InitControlData; override;
  public
    property  ControlInterface: IReportButton read GetControlInterface;
    property  DefaultInterface: IReportButton read GetControlInterface;
  ...
  published
    ...
    property OnKeyPress: TReportButtonOnKeyPress read FOnKeyPress write FOnKeyPress;
...
procedure TReportButton.InitControlData;
const
  ...
  CControlData: TControlData2 = (
    ClassID: '{149CEA2D-A00C-4509-BBDD-1155C4CD2204}';
    EventIID: '{544C4D6E-835F-4F74-8079-8BB359179EAF}';
    EventCount: 8;
...
procedure TReportButton.CreateControl;

  procedure DoCreate;
  begin
    FIntf := IUnknown(OleObject) as IReportButton;
  end;
...
function TReportButton.GetControlInterface: IReportButton;
begin
  CreateControl;
  Result := FIntf;
end;
...
procedure Register;
begin
  RegisterComponents(dtlOcxPage, [TReportButton]);
end;
