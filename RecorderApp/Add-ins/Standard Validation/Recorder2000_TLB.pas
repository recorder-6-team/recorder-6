...
// ************************************************************************  //
// Type Lib: C:\Program Files (x86)\Recorder 6\RecorderApp.exe (1)
...
// Parent TypeLibrary:
//   (0) v1.0 StdValLib, (C:\Localsource\recorder-6\RecorderApp\Add-ins\Standard Validation\StdValLib.tlb)
// Errors:
...
// *********************************************************************//
  IRecorder2000Disp = dispinterface
    ...
    function ShowActiveForm(iForm: {??TGUID}OleVariant): IUnknown; dispid 7;
    ...
    function RequestCOMData(const ARequestor: IRequestor; ASupplierGUID: {??TGUID}OleVariant): IUnknown; dispid 206;
  end;
...
// *********************************************************************//
  IRecorderFormDisp = dispinterface
    ...
    procedure EmbedActiveX(const iControl: IUnknown; iClsId: {??TGUID}OleVariant; 
                           const iParent: IRecorderControl; iLeft: Integer; iTop: Integer; 
...
// *********************************************************************//
  INodeManagerDisp = dispinterface
    ...
    function AddNode(TypeID: Integer; const ParentItemKey: WideString; 
                     var NodeInfo: {??TNodeInfo}OleVariant): WordBool; dispid 201;
    ...
    function GetNodeInfo(TypeID: Integer; const DataFields: Fields; 
                         var NodeInfo: {??TNodeInfo}OleVariant): WordBool; dispid 207;
    function GetSubNodeInfo(ParentTypeID: Integer; Index: Integer; 
                            var NodeInfo: {??TNodeInfo}OleVariant): WordBool; dispid 208;
    function NodeChanged(const ParentItemKey: WideString; var NodeInfo: {??TNodeInfo}OleVariant; 
                         var DetailScreenGUID: {??TGUID}OleVariant): WordBool; dispid 209;
...
// *********************************************************************//
  IDynamicMenuDisp = dispinterface
    ...
    procedure GetItemData(var ActionData: {??TActionData}OleVariant); dispid 202;
...
// *********************************************************************//
  INodeMenuManagerDisp = dispinterface
    ['{6ED9E090-E055-4F58-87F2-412C6CD50379}']
    function GetMenuItemsForNode(ANodeInfo: {??TNodeInfo}OleVariant): IDynamicMenuList; dispid 101;
  end;
