...
uses
  DatabaseServerSelectPage, Settings, Functions, SetupConstants, TextMessages;
...
begin
  ...
  if (lDriveType in [DRIVE_REMOVABLE, DRIVE_CDROM]) or not DirectoryExists(lDrive) then
  begin
