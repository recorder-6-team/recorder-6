...
/****** Object:  UserDefinedFunction [dbo].[LCFormatTaxonDesKind6]    Script Date: 04/06/2008 16:31:30 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
(@TLIKey char(16), @Level INT,@Kind varchar(40),@DictKey varchar(16),@Geostatus varchar(100))
RETURNS varchar(8000)
...
--	
--	V6.4 This version includes uses Kind, Dictionary, Geographic area to exclude  parameter
--	PARAMETERS
--	NAME				DESCRIPTION
...
--      @GeoStatus              Status Geographic Area to be excluded
--	AUTHOR:	Mike Weideli, Littlefield Consultancy 
...
if @Level = 0
    ...
    AND
    TD.STATUS_GEOGRAPHIC_AREA <> @GeoStatus
