/*****Changes following RC issue. 
1. Stop the virtual list table being generated if the Master list is present 
...
IF NOT EXISTS (SELECT * FROM SETTING WHERE NAME = 'Dict Seq' AND DATA > '0000004Q')  
...
/****** Object:  StoredProcedure [dbo].[usp_Populate_Index_Taxon_Virtual]    Script Date: 09/18/2020 14:08:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/*===========================================================================*\
  ...
  Revised September 2020 to stop the generation of virtual lists if dictionary above 0000004Q


\*=========================================================================== */
ALTER PROCEDURE [dbo].[usp_Populate_Index_Taxon_Virtual]
...
ELSE
BEGIN
  DELETE FROM TAXON_LIST_VERSION WHERE TAXON_LIST_VERSION_KEY = 'VIRTUAL_ORGANISM'
  DELETE FROM TAXON_LIST_VERSION WHERE TAXON_LIST_VERSION_KEY = 'VIRTUAL_COLEOPTE'
  DELETE FROM TAXON_LIST WHERE TAXON_LIST_KEY = 'VIRTUAL_ORGANISM'
  DELETE FROM TAXON_LIST WHERE TAXON_LIST_KEY = 'VIRTUAL_COLEOPTE'
END
