...
INSERT INTO USABLE TABLE (USABLE_TABLE_KEY,TABLE_NAME,LINK_TABLE,LINK,APPLY_TO,JOIN_ORDER)
...
INSERT INTO (USABLE_FIELD_KEY,TABLE_NAME,FIELD_NAME,FIELD_DESCRIPTION,FIELD_TYPE,APPLY_TO,
