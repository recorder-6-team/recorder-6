/****** Changes associated with adding new options to search on Recommended taxa ******/

/****** Object:  UserDefinedFunction [dbo].[ufn_FormattedSpeciesName]    Script Date: 09/01/2016 09:31:13 ******/
SET ANSI_NULLS ON
GO
 ...
 * Modified for Mantis 594  November 2015
 " Modified for Mnatis 611  September 2016
\*===========================================================================*/
