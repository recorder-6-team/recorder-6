...
/****** Object:  StoredProcedure [dbo].[usp_Index_Taxon_Designation_Rebuild]    Script Date: 20/09/2015 11:28:11 ******/
SET ANSI_NULLS ON
GO
...
AS
    ...
    INNER JOIN Taxon_List_Item TLI ON TLI.Taxon_List_Item_Key = ITN3.Taxon_List_Item_Key
    INNER JOIN Taxon_Rank TR ON TR.TAXON_RANK_KEY = TLI.TAXON_RANK_KEY AND TR.Sequence > 99  
    AND NOT EXists (Select * FRom Index_taxon_Designation where Index_Taxon_Designation.Taxon_List_Item_Key  = ITN3.Taxon_List_Item_Key and Index_Taxon_Designation.Taxon_Designation_Type_Key = ITD.Taxon_Designation_Type_Key)
