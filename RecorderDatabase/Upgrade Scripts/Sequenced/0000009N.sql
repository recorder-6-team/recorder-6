...
/*============================================================================*\
	Mantis 475: Matching of Location shows corrupt grid refs 
\*============================================================================*/
...
GO
/****** Object:  StoredProcedure [dbo].[usp_IWMatchRemembered_Locations]    Script Date: 03/10/2014 21:33:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
