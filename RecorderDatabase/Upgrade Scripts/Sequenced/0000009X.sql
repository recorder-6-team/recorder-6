/****** Object:  StoredProcedure [dbo].[nbn_exchange_basic_update]    Script Date: 10/19/2015 13:38:16 ******/
SET ANSI_NULLS ON
GO
...
/*===========================================================================*\
  ...
  Updated SGB 16 Jan 2009
          SGB 08 Jul 2010
          MDW 19 Oct 2015(move drop table to end as this causes a problem with
