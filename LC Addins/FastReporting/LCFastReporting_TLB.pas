...
// PASTLWTR : 1.2
// File generated on 21/04/2018 05:59:25 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\localsource\recorder-6\LC Addins\FastReporting\LCFastReporting.tlb (1)
// LIBID: {B1F4BFD4-73BC-427A-AB68-87F597ADD479}
// LCID: 0
// Helpfile: 
// HelpString: LCFastReporting Library
// DepndLst: 
...
const
  ...
  LCFastReportingMajorVersion = 1;
  LCFastReportingMinorVersion = 0;

  LIBID_LCFastReporting: TGUID = '{B1F4BFD4-73BC-427A-AB68-87F597ADD479}';

  IID_IFastReportingX: TGUID = '{AD8B7178-BA78-4B34-A889-8844BE95BE99}';
  DIID_IFastReportingXEvents: TGUID = '{FC485486-AB81-4C10-9CB5-FCEBC5A9A523}';
  CLASS_FastReportingX: TGUID = '{D9A088A1-E986-48C6-BF53-0ABE4FAAB3F6}';
...
// *********************************************************************//
  IFastReportingX = interface;
  IFastReportingXDisp = dispinterface;
  IFastReportingXEvents = dispinterface;

// *********************************************************************//
// Declaration of CoClasses defined in Type Library                       
// (NOTE: Here we map each CoClass to its Default Interface)              
// *********************************************************************//
  FastReportingX = IFastReportingX;
...
// *********************************************************************//
// Interface: IFastReportingX
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {AD8B7178-BA78-4B34-A889-8844BE95BE99}
// *********************************************************************//
  IFastReportingX = interface(IDispatch)
    ['{AD8B7178-BA78-4B34-A889-8844BE95BE99}']
...
// *********************************************************************//
// DispIntf:  IFastReportingXEvents
// Flags:     (4096) Dispatchable
// GUID:      {FC485486-AB81-4C10-9CB5-FCEBC5A9A523}
// *********************************************************************//
  IFastReportingXEvents = dispinterface
    ['{FC485486-AB81-4C10-9CB5-FCEBC5A9A523}']
...
// Control Name     : TFastReportingX
// Help String      : FastReportingX Control
// Default Interface: IFastReportingX
// Def. Intf. DISP? : No
// Event   Interface: IFastReportingXEvents
// TypeFlags        : (34) CanCreate Control
// *********************************************************************//
  TFastReportingXOnKeyPress = procedure(ASender: TObject; var Key: Smallint) of object;

  TFastReportingX = class(TOleControl)
  private
    ...
    FOnKeyPress: TFastReportingXOnKeyPress;
    FOnPaint: TNotifyEvent;
    FIntf: IFastReportingX;
    function  GetControlInterface: IFastReportingX;
  protected
    procedure CreateControl;
    procedure InitControlData; override;
  public
    property  ControlInterface: IFastReportingX read GetControlInterface;
    property  DefaultInterface: IFastReportingX read GetControlInterface;
  ...
  published
    ...
    property OnKeyPress: TFastReportingXOnKeyPress read FOnKeyPress write FOnKeyPress;
...
procedure TFastReportingX.InitControlData;
const
  ...
  CControlData: TControlData2 = (
    ClassID: '{D9A088A1-E986-48C6-BF53-0ABE4FAAB3F6}';
    EventIID: '{FC485486-AB81-4C10-9CB5-FCEBC5A9A523}';
    EventCount: 8;
...
procedure TFastReportingX.CreateControl;

  procedure DoCreate;
  begin
    FIntf := IUnknown(OleObject) as IFastReportingX;
  end;
...
function TFastReportingX.GetControlInterface: IFastReportingX;
begin
  CreateControl;
  Result := FIntf;
end;
...
procedure Register;
begin
  RegisterComponents(dtlOcxPage, [TFastReportingX]);
end;
