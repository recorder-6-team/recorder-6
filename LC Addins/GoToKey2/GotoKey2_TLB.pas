...
const
  ...
  GotoKey2MajorVersion = 1;
  GotoKey2MinorVersion = 0;

  LIBID_GotoKey2: TGUID = '{B92B3A65-DE7A-427B-BBEC-780A99BE0247}';

  IID_IGotoKey2X: TGUID = '{48D57ED8-A878-4ED9-B146-CFC70B965B34}';
  DIID_IGotoKey2XEvents: TGUID = '{E5A3D231-E7A9-4CBE-8E93-000FC293CF01}';
  CLASS_GotoKey2X: TGUID = '{70477CEA-3FC4-4652-8AD2-3850D40E78DA}';
...
// *********************************************************************//
  IGotoKey2X = interface;
  IGotoKey2XDisp = dispinterface;
  IGotoKey2XEvents = dispinterface;

// *********************************************************************//
// Declaration of CoClasses defined in Type Library                       
// (NOTE: Here we map each CoClass to its Default Interface)              
// *********************************************************************//
  GotoKey2X = IGotoKey2X;
...
// *********************************************************************//
// Interface: IGotoKey2X
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {48D57ED8-A878-4ED9-B146-CFC70B965B34}
// *********************************************************************//
  IGotoKey2X = interface(IDispatch)
    ['{48D57ED8-A878-4ED9-B146-CFC70B965B34}']
...
// *********************************************************************//
// DispIntf:  IGotoKey2XEvents
// Flags:     (4096) Dispatchable
// GUID:      {E5A3D231-E7A9-4CBE-8E93-000FC293CF01}
// *********************************************************************//
  IGotoKey2XEvents = dispinterface
    ['{E5A3D231-E7A9-4CBE-8E93-000FC293CF01}']
...
// Control Name     : TGotoKey2X
// Help String      : GotoKey2X Control
// Default Interface: IGotoKey2X
// Def. Intf. DISP? : No
// Event   Interface: IGotoKey2XEvents
// TypeFlags        : (34) CanCreate Control
// *********************************************************************//
  TGotoKey2XOnKeyPress = procedure(ASender: TObject; var Key: Smallint) of object;

  TGotoKey2X = class(TOleControl)
  private
    ...
    FOnKeyPress: TGotoKey2XOnKeyPress;
    FOnPaint: TNotifyEvent;
    FIntf: IGotoKey2X;
    function  GetControlInterface: IGotoKey2X;
  protected
    procedure CreateControl;
    procedure InitControlData; override;
  public
    property  ControlInterface: IGotoKey2X read GetControlInterface;
    property  DefaultInterface: IGotoKey2X read GetControlInterface;
  ...
  published
    ...
    property OnKeyPress: TGotoKey2XOnKeyPress read FOnKeyPress write FOnKeyPress;
...
procedure TGotoKey2X.InitControlData;
const
  ...
  CControlData: TControlData2 = (
    ClassID: '{70477CEA-3FC4-4652-8AD2-3850D40E78DA}';
    EventIID: '{E5A3D231-E7A9-4CBE-8E93-000FC293CF01}';
    EventCount: 8;
...
procedure TGotoKey2X.CreateControl;

  procedure DoCreate;
  begin
    FIntf := IUnknown(OleObject) as IGotoKey2X;
  end;
...
function TGotoKey2X.GetControlInterface: IGotoKey2X;
begin
  CreateControl;
  Result := FIntf;
end;
...
procedure Register;
begin
  RegisterComponents(dtlOcxPage, [TGotoKey2X]);
end;
