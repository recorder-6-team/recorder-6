...
// PASTLWTR : 1.2
// File generated on 29/09/2015 14:46:13 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\localsource\recorder-6\LC Addins\PhenologyNu\PhenologyNu.tlb (1)
// LIBID: {56361873-DF3D-4D32-A3E4-1F7B547D8C14}
// LCID: 0
// Helpfile: 
// HelpString: PhenologyNu Library
// DepndLst: 
...
const
  ...
  PhenologyNuMajorVersion = 1;
  PhenologyNuMinorVersion = 0;

  LIBID_PhenologyNu: TGUID = '{56361873-DF3D-4D32-A3E4-1F7B547D8C14}';

  IID_IPhenologyFormX: TGUID = '{5F68CE0A-335C-4641-AA71-F02BA34E5D86}';
  DIID_IPhenologyFormXEvents: TGUID = '{E328BC5E-0905-4CB0-A9C3-2ADA96E1E2F1}';
  CLASS_PhenologyFormX: TGUID = '{D79FCA0D-6A4B-4A69-8D7F-346134377B0A}';
...
// *********************************************************************//
  IPhenologyFormX = interface;
  IPhenologyFormXDisp = dispinterface;
  IPhenologyFormXEvents = dispinterface;

// *********************************************************************//
// Declaration of CoClasses defined in Type Library                       
// (NOTE: Here we map each CoClass to its Default Interface)              
// *********************************************************************//
  PhenologyFormX = IPhenologyFormX;
...
// *********************************************************************//
// Interface: IPhenologyFormX
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {5F68CE0A-335C-4641-AA71-F02BA34E5D86}
// *********************************************************************//
  IPhenologyFormX = interface(IDispatch)
    ['{5F68CE0A-335C-4641-AA71-F02BA34E5D86}']
...
// *********************************************************************//
// DispIntf:  IPhenologyFormXEvents
// Flags:     (4096) Dispatchable
// GUID:      {E328BC5E-0905-4CB0-A9C3-2ADA96E1E2F1}
// *********************************************************************//
  IPhenologyFormXEvents = dispinterface
    ['{E328BC5E-0905-4CB0-A9C3-2ADA96E1E2F1}']
...
// Control Name     : TPhenologyFormX
// Help String      : PhenologyFormX Control
// Default Interface: IPhenologyFormX
// Def. Intf. DISP? : No
// Event   Interface: IPhenologyFormXEvents
// TypeFlags        : (34) CanCreate Control
// *********************************************************************//
  TPhenologyFormXOnKeyPress = procedure(ASender: TObject; var Key: Smallint) of object;

  TPhenologyFormX = class(TOleControl)
  private
    ...
    FOnKeyPress: TPhenologyFormXOnKeyPress;
    FOnPaint: TNotifyEvent;
    FIntf: IPhenologyFormX;
    function  GetControlInterface: IPhenologyFormX;
  protected
    procedure CreateControl;
    procedure InitControlData; override;
  public
    property  ControlInterface: IPhenologyFormX read GetControlInterface;
    property  DefaultInterface: IPhenologyFormX read GetControlInterface;
  ...
  published
    ...
    property OnKeyPress: TPhenologyFormXOnKeyPress read FOnKeyPress write FOnKeyPress;
...
procedure TPhenologyFormX.InitControlData;
const
  ...
  CControlData: TControlData2 = (
    ClassID: '{D79FCA0D-6A4B-4A69-8D7F-346134377B0A}';
    EventIID: '{E328BC5E-0905-4CB0-A9C3-2ADA96E1E2F1}';
    EventCount: 8;
...
procedure TPhenologyFormX.CreateControl;

  procedure DoCreate;
  begin
    FIntf := IUnknown(OleObject) as IPhenologyFormX;
  end;
...
function TPhenologyFormX.GetControlInterface: IPhenologyFormX;
begin
  CreateControl;
  Result := FIntf;
end;
...
procedure Register;
begin
  RegisterComponents(dtlOcxPage, [TPhenologyFormX]);
end;
