...
For Recorder 6.22 (won't work with Recorder 6 versions earlier that 6.19!)

NBN Exchange export addin v6.22 of 6 March 2014
...
============  
     ...
     2.  Unpack the files from the supplied .zip file to some convenient directory accessible
         by the computer running Recorder 6 .
	 ...
	 the dll file in the directory to which you unpacked the files in step 2.


     5.  You should see messages reporting that the add-in has been installed and it should 
         appear in the list of add-ins in the "Add-ins Configuration" window.

     6.  If you re-installing the add-in you may see messages saying the add-in has been 
