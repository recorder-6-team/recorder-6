...
type
  ...
  private
    ...
    function Get_ExportInvalid: boolean;
  public
    { Public declarations }
    ...
    property ExportInvalid: boolean read Get_ExportInvalid;
...
function TformOptions.Get_ExportInvalid: boolean;
begin
  Result := cbFailedValidation.Checked;
end;
