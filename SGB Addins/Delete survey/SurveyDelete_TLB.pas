...
// PASTLWTR : 1.2
// File generated on 11/08/2009 11:20:15 from Type Library described below.

// ************************************************************************  //
// Type Lib: D:\Delphi stuff\Recorder 6 addins\Delete_survey\SurveyDelete.tlb (1)
// LIBID: {8707DCE2-C83A-4282-B13D-B01C06AEBFF4}
// LCID: 0
// Helpfile: 
// HelpString: SurveyDelete Library
// DepndLst: 
...
const
  ...
  SurveyDeleteMajorVersion = 1;
  SurveyDeleteMinorVersion = 0;

  LIBID_SurveyDelete: TGUID = '{8707DCE2-C83A-4282-B13D-B01C06AEBFF4}';

  IID_ISurveyDeleteX: TGUID = '{33F2CDDC-9A10-486D-BADD-03B716B50CE8}';
  DIID_ISurveyDeleteXEvents: TGUID = '{F2F5C4E2-E3F1-41B5-B687-6AF98DE063EF}';
  CLASS_SurveyDeleteX: TGUID = '{72C38FAD-8AD5-44D4-A8E1-FEF56080D5F7}';
...
// *********************************************************************//
  ISurveyDeleteX = interface;
  ISurveyDeleteXDisp = dispinterface;
  ISurveyDeleteXEvents = dispinterface;

// *********************************************************************//
// Declaration of CoClasses defined in Type Library                       
// (NOTE: Here we map each CoClass to its Default Interface)              
// *********************************************************************//
  SurveyDeleteX = ISurveyDeleteX;
...
// *********************************************************************//
// Interface: ISurveyDeleteX
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {33F2CDDC-9A10-486D-BADD-03B716B50CE8}
// *********************************************************************//
  ISurveyDeleteX = interface(IDispatch)
    ['{33F2CDDC-9A10-486D-BADD-03B716B50CE8}']
...
// *********************************************************************//
// DispIntf:  ISurveyDeleteXEvents
// Flags:     (4096) Dispatchable
// GUID:      {F2F5C4E2-E3F1-41B5-B687-6AF98DE063EF}
// *********************************************************************//
  ISurveyDeleteXEvents = dispinterface
    ['{F2F5C4E2-E3F1-41B5-B687-6AF98DE063EF}']
...
// Control Name     : TSurveyDeleteX
// Help String      : SurveyDeleteX Control
// Default Interface: ISurveyDeleteX
// Def. Intf. DISP? : No
// Event   Interface: ISurveyDeleteXEvents
// TypeFlags        : (34) CanCreate Control
// *********************************************************************//
  TSurveyDeleteXOnKeyPress = procedure(ASender: TObject; var Key: Smallint) of object;

  TSurveyDeleteX = class(TOleControl)
  private
    ...
    FOnKeyPress: TSurveyDeleteXOnKeyPress;
    FOnMouseEnter: TNotifyEvent;
    FOnMouseLeave: TNotifyEvent;
    FOnPaint: TNotifyEvent;
    FIntf: ISurveyDeleteX;
    function  GetControlInterface: ISurveyDeleteX;
  protected
    procedure CreateControl;
    procedure InitControlData; override;
  public
    property  ControlInterface: ISurveyDeleteX read GetControlInterface;
    property  DefaultInterface: ISurveyDeleteX read GetControlInterface;
  ...
  published
    ...
    property OnKeyPress: TSurveyDeleteXOnKeyPress read FOnKeyPress write FOnKeyPress;
...
procedure TSurveyDeleteX.InitControlData;
const
  ...
  CControlData: TControlData2 = (
    ClassID: '{72C38FAD-8AD5-44D4-A8E1-FEF56080D5F7}';
    EventIID: '{F2F5C4E2-E3F1-41B5-B687-6AF98DE063EF}';
    EventCount: 10;
...
procedure TSurveyDeleteX.CreateControl;

  procedure DoCreate;
  begin
    FIntf := IUnknown(OleObject) as ISurveyDeleteX;
  end;
...
function TSurveyDeleteX.GetControlInterface: ISurveyDeleteX;
begin
  CreateControl;
  Result := FIntf;
end;
...
procedure Register;
begin
  RegisterComponents(dtlOcxPage, [TSurveyDeleteX]);
end;
